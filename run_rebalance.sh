...
python main.py --config live-data/credentials.json --exchange-type live get-portfolio > $OUTFOLDER/portfolio.json
...
python main.py --config live-data/credentials.json --exchange-type live get-target-allocations equidistrib $OUTFOLDER/portfolio.json --exclude EUR > $OUTFOLDER/target-allocations.json
